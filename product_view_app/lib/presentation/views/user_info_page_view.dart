...
class _UserInfoPageViewState extends State<UserInfoPageView> {
  ...
  void initState() {
    super.initState();
    mobileController.text = "08999999";
    addressController.text = "TPHCM";
    dropdownValue = "Male";
  }
    ...
    buildInfoContent() {
      buildItemReadOnly() {
        ...
        return Column(
          ...
          children: [
            buildItem(title: "Mobile: ", content: "08999999"),
            const SizedBox(
              height: 14.0,
            ),
            buildItem(title: "Gender: ", content: "Male"),
            const SizedBox(
              height: 14.0,
            ),
            buildItem(title: "Address: ", content: "TPHCM"),
            const SizedBox(
              height: 14.0,
            ),
            SizedBox(
